...
module.exports = function(sequelize, DataTypes) {
	let God = sequelize.define('God', {
		...
		getterMethods: {
			damage_Growth_Rate_Type: function() {return this.damage_Growth_Rate_2.split(' of ')[1]},
			damage_Growth_Rate_Inc: function() {return returnDecimalFLOAT(this.damage_Growth_Rate_2.split(' of ')[0])}
		}
	})
	return God;
}
...
function spaceBetweenWords(){
	...
	var spaceAdded = type.replace(/([a-z])([A-Z])/, (match, p1, p2) => p1+' '+p2);
	return spaceAdded;
}
...
function prosToArray(){
	...
	let re = /\s(:?High|Medium|Great|Pusher)/;
